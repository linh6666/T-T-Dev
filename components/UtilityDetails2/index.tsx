...
interface ZoningSystemProps {
  ...
  initiallayer4?: string | null; // thêm prop mới
}

export default function ZoningSystem({ project_id, initiallayer4 }: ZoningSystemProps) {
    ...
    <div className={styles.box}>
     ...
     minScale={1} 
      ...
      <div className={styles.right}>
        ...
        <Menu project_id={project_id} initiallayer4={initiallayer4} 
