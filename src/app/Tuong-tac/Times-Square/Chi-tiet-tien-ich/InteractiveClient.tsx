...
import ZoningSystem from "../../../../../components/UtilityDetails3";
...
export default function InteractiveClient() {
  ...
  if (!project_id) return <div>Không có project_id trong URL</div>;
   if (!layer2) return <div>Không có layer4 trong URL</div>;

  return <ZoningSystem project_id={project_id} initiallayer2={layer2} />;
}
