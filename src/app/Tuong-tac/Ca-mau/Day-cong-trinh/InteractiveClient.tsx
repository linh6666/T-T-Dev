...
import ZoningSystem from "../../../../../components/Seriesofbuildings";
...
export default function InteractiveClient() {
  ...
  const layer5 = searchParams.get("layer5");
   const layer4 = searchParams.get("layer4"); // ← phase_vi được truyền từ Menu
  ...
  return <ZoningSystem project_id={project_id} phase={layer5} layer4={layer4}/>;
}
