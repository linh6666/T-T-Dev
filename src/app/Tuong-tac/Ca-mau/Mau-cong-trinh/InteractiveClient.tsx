...
import ZoningSystem from "../../../../../components/Detail2";

export default function InteractiveClient() {
  // Lấy project_id và phase_vi từ URL query
  const searchParams = useSearchParams();
  const project_id = searchParams.get("id");
  const layer5 = searchParams.get("layer5"); // ← phase_vi được truyền từ Menu
  ...
  return <ZoningSystem project_id={project_id} phase={layer5} />;
}
